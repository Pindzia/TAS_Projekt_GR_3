...
INSERT INTO Ksiazka(autor, tytul, cena, dict_img, kategoria) VALUES
            ...
            ("Arnold Lobel", "Zabek i Ropuch. Przez cały rok", "28.99", "images/covers/zabek.jpg", "Ksiazki dla dzieci"),
            ("Paula Hawkins", "Dziewczyna z pociagu", "32.90", "images/covers/dziewczyna.jpg", "Literatura sensacyjna"),
            ("Rick Riordan", "Greccy Herosi według Percy'ego Jacksona", "49.90", "images/covers/percy.jpg", "Podroze, Ksiazki dla młodziezy"),
            ("Remigiusz Grzela, Barbara Krafftowna", "Krafftowna w krainie czarow", "39.90", "images/covers/krafft.jpg", "Biografia"),
            ("Krystyna Mirek", "Jabłoniowy Sad. Rodzinne sekrety", "36.90", "images/covers/jablon.jpg", "Literatura piekna"),
            ...
            ("Joanna Opiat-Bojarska", "Gdzie jestes, Leno?", "24.90", "images/covers/gdzie.jpg", "Kryminał"),
            ("Alice Milani", "Wisława Szymborska. Zycie w obrazkach", "49.90", "images/covers/wislawa.jpg", "Literatura piekna"),
            ("Stephen Baxter, Terry Pratchett", "Długa utopia", "32.49", "images/covers/dluga.jpg", "Fantastyka"),
            ("Mo O'Hara", "Moja złota rybka zombie", "24.90", "images/covers/moja.jpg", "Ksiazki dla dzieci"),
            ...
            ("Andrzej Batko", "Haker umysłow", "32.90", "images/covers/haker.jpg", "Psychologia"),
